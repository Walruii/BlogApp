export default function About() {
  return (
    <div>
      ...
      <p>Welcome to BlogApp! We're delighted to have you join us on this digital journey of exploration and discovery. Our mission is to provide a platform where knowledge meets creativity, where ideas find their voice, and where diverse perspectives come together to shape conversations.<br />
        <br />
        Our Story<br />
        <br />
